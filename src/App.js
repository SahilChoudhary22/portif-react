...
const markup =<Typing speed={75}> 
  <ul>
    <li>const state = {}</li>
    <li> </li>
    <li children="const FullStackDeveloper = () => {" />
    <li> </li>
    <li class="ml-8">const name = "Sahil Choudhary";</li>
    <li>let locate = "Delhi, India"</li>
    <li></li>
    <li>skills(name, skillsList);</li>
    <li></li>
    <li>};</li>
    <li children="const skills = (name) => {" />
    <li></li>
    <li children="console.log(${name} from ${locate} is efficient in); " />
    <li>forEach()</li>
    <li>};</li>
    <li></li>
    <li children="const skillsList = {" />
    <li></li>
    <li>primLanguage: "Python",</li>
    <li>secLanguage: "JavaScript",</li>
    <li>backEnd: "Django",</li>
    <li>frontEnd: "React",</li>
    <li>databaseLang: "SQL"</li>
    <li>favDatabase: "PostgreSQL"</li>
...
function App() {
  ...
  return (
    <div>
      <div className="flex grid grid-cols-1 sm:grid-cols-2 md:items-center md:grid-cols-4 lg:grid-cols-8 xl:grid-cols-10 lg:flex sm:px-10 md:px-12 lg:px-48 md:grid-rows-2 lg:grid-rows-1 gap-2 pt-5" >
        <div class="col-span-1 sm:col-span-2 md:col-span-4 lg:col-span-4 xl:col-span-5 sm:px-10 md:px-12 lg:px-36">
          ...
          <div className="font-bold tracking-wider subpixel-antialiased text-gray-800 wideFonta sm:px-4 md:px-12 lg:px-36 text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl text-center lg:text-left lg:text-left ">Sahil Choudhary</div>
          ...
          <div className="container mx-auto p-4 px-10 leading-loose text-xl text-gray-800 sm:px-4 md:px-12 lg:px-36 " >
            <div className="font-semibold sm:px-4 md:px-12 lg:px-36 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center">I build <span className="italic">elegant</span> web apps with state-of-the-art frameworks including <span className="border-b-2 border-red-400 rounded text-gray-800">Django</span> and <span className="border-b-2 border-red-400 rounded text-gray-800">React</span>. Also familiar with <span className="border-b-2 border-red-400 rounded text-gray-800">Data Science</span> techniques and <span className="border-b-2 border-red-400 rounded text-gray-800">Machine Learning</span> technologies.<span></span></div>
            <div className="font-semibold sm:px-4 md:px-12 lg:px-36 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-center"><br/>Therefore, a--wait for it...<br/> <span className="bg-gray-800 text-center rounded text-gray-200 my-2 pl-1 pr-1">Full-Stack Developer</span></div>
      ...
      <Typing><h2 id="projID" class="text-center text-5xl consoEmu">Projects</h2></Typing>
            ...
            <div class="border-r border-b border-l border-gray-400 lg:border-l-1 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              <div class="mb-8">
                <p class="text-sm text-gray-600 flex items-center">
                  {p1.type}</p>
                <div class="text-gray-900 font-bold text-xl mb-2">{p1.name} <a href={p1.link} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 text-right">Github Page</a></div>
                <p class="text-gray-700 text-base break-normal">{p1.desc}</p>
              </div>
              <div class="flex items-center">
              <span className="font-mono mr-2 ">Technologies Used : </span>
                ...
                <div class="text-sm">
                  <p class="text-gray-600 ml-2">{p1.dateyear}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="max-w-full w-full lg:max-w-full lg:flex">
            <div class="border-r border-b border-l border-gray-400 lg:border-l-1 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              ...
              <span className="font-mono mr-2 ">Technologies Used : </span>
                ...
                <div class="text-sm">
                  <p class="text-gray-600 ml-2">{p2.dateyear}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="max-w-full w-full lg:max-w-full lg:flex">
            <div class="border-r border-b border-l border-gray-400 lg:border-l-1 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              ...
              <div class="flex items-center">
                ...
                <div class="text-sm">
                  <p class="text-gray-600 ml-2 flex-1">{p3.dateyear}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" max-w-full w-full">
            <div class="border-r border-b border-l border-gray-400 lg:border-l-1 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              ...
              <span className="font-mono mr-2 ">Technologies Used : </span>
                ...
                <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">{p4.tags[2]}</span>
                <div class="text-sm">
                  <p class="text-gray-600 ml-2">{p4.dateyear}</p>
                </div>
              </div>
            </div>
          </div>
